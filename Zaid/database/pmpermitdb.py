...
collection = cli["Zika"]["pmpermit"]

PMPERMIT_MESSAGE = (
    "**ᴘᴇʀʜᴀᴛɪᴀɴ!⚠️ ᴛᴏʟᴏɴɢ ʙᴀᴄᴀ ᴘᴇꜱᴀɴ ɪɴɪ..\n\n**"
    "**ꜱᴀʏᴀ ɪɢɴ ᴜꜱᴇʀʙᴏᴛ ꜱᴀʏᴀ ᴀᴅᴀ ᴜɴᴛᴜᴋ ᴍᴇɴᴊᴀɢᴀ ᴛᴜᴀɴ ꜱᴀʏᴀ ᴅᴀʀɪ ᴏʀᴀɴɢ ᴄᴀʙᴜʟ.**"
    "**ᴍᴇɴᴅɪɴɢ ʟᴜ ɢᴀᴋ ᴜꜱᴀʜ ꜱᴘᴀᴍᴍɪɴɢ!.\n\n**"
    "**ᴋᴀʟᴏ ʟᴜ ꜱᴘᴀᴍ ɴᴀɴᴛɪ ɢᴜᴇ ʙʟᴏᴄᴋ!**"
    "**ᴘᴏᴡᴇʀᴇᴅ ʙʏ ɪɢɴ ᴜʙᴏᴛ!**"
)

BLOCKED = "**ɴᴀʜ ᴋᴀɴ ʟᴜ ᴋᴇɴᴀ ʙʟᴏᴋ!**"
